...
from app.services.data_loader import CAPA_PATH
...
def render_homepage():
    ...
    with col2:
        st.markdown("""
        ### Sobre o Projeto
        Aplicação analítica desenvolvida para investigar o comportamento histórico do Brent,
        conectar oscilações de preço a eventos globais e apresentar previsões de curto prazo
